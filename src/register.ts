 ...
 */
export const register = (component: AnyComponent, name: string,) => {
...
export const isComponentRegistered = (component: unknown,) => component2name.has(component as AnyComponent)

export const getName = (component: AnyComponent,) => {
