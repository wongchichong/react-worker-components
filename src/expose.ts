...
const render = <Props extends { children?: ReactNode }>(Component: React.FC<Props>, props: Props) => {
...
const walk = <T>(x: T): T => {
    ...
    const obj = x as Record<string, any> & { children?: ReactNode }
 ...
 * expose(Foo);
 */
export const expose = <Props extends { children?: ReactNode }>(Component: React.FC<Props>, key?: string) => {
